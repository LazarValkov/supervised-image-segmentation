...
void computeMeasures(Mat &waveletImg, Mat &waveletImg_mean, Mat &waveletImg_variance, Mat &waveletImg_std, int row_from, int row_to, int col_from, int col_to, int winSize);
...
void ImageAnalyser::addWaveletMeasures(string& waveletFilename, vector<Mat>& inputFeatureMatrixVector) {
