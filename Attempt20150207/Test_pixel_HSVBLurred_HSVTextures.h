...
class Test_pixel_HSVBlurred_HSVTextures : public Tester {
public:

	Test_pixel_HSVBlurred_HSVTextures(bool ttrainClassifier, bool lloadClassifierFromFile, GlobalVariables::Organ organ)
		: Tester(ttrainClassifier, lloadClassifierFromFile) {
		description = "Test_grid_HSVBlurred_HSVTextures";
		classifierFilename = classifiersStoreFolder + "Test_pixel_HSVBlurred_HSVTextures_Heart.txt";
		classifierType = Classifier::ClassifierType::NeuralNetwork;
		IAFunctions = ImageAnalyser::IA_Functions::ADD_HSV_BLURRED | ImageAnalyser::IA_Functions::ADD_LAWS_ENERGY_MEASURES_ON_HSV;
